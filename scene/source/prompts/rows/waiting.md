Create one horizontal animation strip for Codex pet `scene`, state `waiting`.
...
Scene-specific action: gently raise her head toward the user, one hand lightly lifted near her chest in a reserved asking pose, pausing expectantly, maintaining her calm sleepy-eyed persona.
