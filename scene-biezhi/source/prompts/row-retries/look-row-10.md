Create Codex v2 pet look row 10 for `scene-biezhi` as exactly 8 full-body frames in this order: 180, 202.5, 225, 247.5, 270, 292.5, 315, 337.5.
...
Use a flat pure cyan #00FFFF background. One complete unclipped pose per invisible slot. No whole-sprite rotation, replacement eyes, labels, guide marks, shadows, glows, scenery, detached effects, or #00FFFF colors in the pet.
