Create one horizontal four-cardinal anchor strip for Codex pet `scene-biezhi`.
...
Place one pose in each invisible equal-width slot on a flat pure cyan #00FFFF background with generous padding. Keep scale, feet/base, lower body, and registration consistent across all four slots.
