Repair one cardinal anchor for Codex pet `scene-biezhi`: `090` means looking right.
...
Output one centered complete full-body pose on a flat pure cyan #00FFFF background with generous padding. Keep the feet/base and lower body registered to the approved anchors. The requested cardinal must be unmistakable at final 192x208 display size.
