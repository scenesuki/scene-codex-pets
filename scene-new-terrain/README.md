...
以《明日方舟》干员“稀音”的生命之地时装“新地形”和基建小人比例为参考制作的 Codex v2 动画宠物。

[返回项目总览](../README.md)

![稀音·新地形动作总览](preview/contact-sheet.png)

## 安装

1. 创建宠物目录 `~/.codex/pets/scene-new-terrain/`。
2. 将本目录中的 `pet.json` 和 `spritesheet.webp` 一起复制到该目录。
3. 重新打开 Codex；宠物名称将显示为“稀音·新地形”。
